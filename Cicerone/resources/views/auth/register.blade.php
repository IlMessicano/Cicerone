                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-4">
                                <input id="sesso" placeholder="Sesso" type="text" class="form-control @error('sesso') is-invalid @enderror" name="sesso" value="{{ old('sesso') }}" required autocomplete="sesso" autofocus>
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-4">
                                <input id="name" placeholder="Cognome" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            ...
                            <div class="col-md-4">
                                <input id="nazionalita" placeholder="Nazionalitá" type="text" class="form-control @error('nazionalita') is-invalid @enderror" name="nazionalita" value="{{ old('nazionalita') }}" required autocomplete="nazionalita" autofocus>
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-4">
                                <input id="cittaresidenza" placeholder="Cittá di residenza" type="text" class="form-control @error('cittaresidenza') is-invalid @enderror" name="cittaresidenza" value="{{ old('cittaresidenza') }}" required autocomplete="cittaresidenza" autofocus>
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-4">
                                <input id="nazionalitaresidenza" placeholder="Nazionalitá di residenza" type="text" class="form-control @error('nazionalitaresidenza') is-invalid @enderror" name="nazionalitaresidenza" value="{{ old('nazionalitaresidenza') }}" required autocomplete="nazionalitaresidenza" autofocus>
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-4">
                                <input id="password" placeholder="Password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" required autocomplete="new-password" autofocus>
                            ...
                            <div class="col-md-4">
                                <input id="telefono" placeholder="Telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono') }}" required autocomplete="telefono" autofocus>
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-4">
                                <input id="biografia" placeholder="Biografia" type="text" class="form-control @error('biografia') is-invalid @enderror" name="biografia" value="{{ old('biografia') }}" required autocomplete="biografia" autofocus>
