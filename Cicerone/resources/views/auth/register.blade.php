            ...
            <div class="row">
                    ...
                    <div class="shadow p-4 my-4 mx-2 bg-white ">
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="nationality" placeholder="Nazionalitá"
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3 pl-0">
                                        ...
                                        <input id="phone" placeholder="Telefono" type="number"
                ...
                <div class="col-md-4 order-md-2">
                    <div class="shadow p-4 my-4 mx-2 bg-white ">
                        ...
                        <div class="">
                            <img src=""
                                 class="rounded-circle my-5" id="">
                            <div class="form-group{{ $errors->has('imgProfile') ? ' has-error' : '' }}">

                                <label class="col-md-4 control-label"></label>

                                <div class="col-md-6">

                                    <div class="center-block" style="width:800px;display:none">
                                    </div>
