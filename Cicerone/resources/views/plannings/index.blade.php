        ...
        <div class="shadow p-4 m-4 bg-white">
            ...
            <div class="text-left  mx-3">
                <a class="btn btn-primary btn-lg "
                   href="http://127.0.0.1:8000/activityplannings/create/{{$attivita->ActivityId}}">Crea una nuova
                    pianificazione</a>
            </div>
            @if(count($plans)>0)
                        ...
                        <div class="card bg-light text-dark m-3">
                            <div class="card-body">
                                <div class="form-group row col-md-12 text-center">
                                    ...
                                    @php($endDate = \Carbon\Carbon::parse($plan->stopDate))
                                    <div class="col-md-3 mb-1">
                                        @if( $endDate->isPast() && !is_null($plan->stopDate))

                                            <a class="btn btn-info btn-lg btn-block disabled" style="color: white">Attività
                                                conclusa, impossibile modificarla.</a>
                                ...
                                <div class="form-group row col-md-12 text-center">
                                    ...
                                    <div class="col-md-3 mb-1">
                                        @if( $endDate->isPast()&& !is_null($plan->stopDate))
                                            <a class="btn btn-danger btn-lg btn-block disabled">
                                                Attività conclusa, impossibile eliminare.
                                            </a>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Sei sicuro di
                                                                voler cancellare questa pianificazione?</h5>
